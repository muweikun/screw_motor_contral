...
#ifndef __ROBO_LIB_VECTOR3_H__
#define __ROBO_LIB_VECTOR3_H__
...
public:
  ...
  {
    return robo_lib::isZero(x) && robo_lib::isZero(y) && robo_lib::isZero(z);
  }
  ...
  void normalize(void)
  {
    T recip_norm = (T) robo_lib::invSqrt(x * x + y * y + z * z);
    x *= recip_norm;
    y *= recip_norm;
    z *= recip_norm;
  }
