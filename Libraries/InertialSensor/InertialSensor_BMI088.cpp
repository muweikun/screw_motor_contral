...
bool InertialSensor_BMI088::init(void)
{
  ...
  accel_lpf = robo_lib::LowPassFilter<robo_lib::Vector3f>(1.0f / 400.0f, 40);
...
{
  robo_lib::Vector3f temp_vec = accel;
  ...
  else if (imu.accel_orientation[id] == ROTATION_PITCH_90)
  {
    accel.x =   temp_vec.z;
    accel.y =   temp_vec.y;
    accel.z = - temp_vec.x;
  }
  else if (imu.accel_orientation[id] == ROTATION_ROLL_180_PITCH_90)
  {
    accel.x =   temp_vec.z;
    accel.y = - temp_vec.y;
    accel.z =   temp_vec.x;
  }
  else if (imu.accel_orientation[id] == ROTATION_YAW_90)
  {
    accel.x =   temp_vec.y;
    accel.y = - temp_vec.x;
    accel.z =   temp_vec.z;
...
{
  robo_lib::Vector3f temp_vec = gyro_calib;
  ...
  {
    gyro_calib.x =   temp_vec.z;
    gyro_calib.y =   temp_vec.y;
    gyro_calib.z = - temp_vec.x;
  }
  else if (imu.accel_orientation[id] == ROTATION_ROLL_180_PITCH_90)
  {
    gyro_calib.x =   temp_vec.z;
