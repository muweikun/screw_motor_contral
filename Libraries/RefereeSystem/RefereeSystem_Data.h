...
typedef __PACKED_STRUCT
{
  ...
  uint16_t shooter_id1_17mm_cooling_heat;//第 1 个 17mm 发射机构的枪口热量
  uint16_t shooter_id2_17mm_cooling_heat;//第 2 个 17mm 发射机构的枪口热量
  uint16_t shooter_id1_42mm_cooling_heat;//42mm 发射机构的枪口热量
  timeus_t timestamp;
...
typedef __PACKED_STRUCT
{
	uint32_t free_reborn : 1;
	uint32_t coin_reborn : 1;
	uint32_t normal_bullet : 11;
